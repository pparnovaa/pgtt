...
H_0_s = H_0*(1-ro)
H_0_r = H_0*ro
print(f'h_0 = {point_0.h:.4f} кДж/кг')
h_1t = point_0.h - H_0_s
print(f'h_1t = {h_1t:.4f} кДж/кг')
point_1t = WSP(h=h_1t, s=point_0.s)
c_1t = (2000*H_0_s)**0.5
print(f'c_1t = {c_1t:.4f} м/с')
M_1t = c_1t/point_1t.w
print(f'M_1t = {M_1t:.4f}')
mu_1 = 0.982 - 0.005*(b_1/l_1)
...
print(f'fi_1 = {fi_1}')
print(f'Ksi_1 = {Ksi_1}')
print(f'alpha_inst1 = {alpha_inst1}')
print(alpha_inst1)
c_1 = c_1t*fi_1
phi_s = 0.97509
...
if betta_2e <= 15:
    ...
    f2_mod = 2.44
    W2_mod = 0.39
    beta_inst2 = betta_2e-12.5*(t2_-0.75)+20.2
    ...
    f2_mod = 2.07
    W2_mod = 0.225
    beta_inst2 = betta_2e-19.3*(t2_-0.6)+60
    ...
    f2_mod = 1.85
    W2_mod = 0.234
    beta_inst2 = betta_2e-12.8*(t2_-0.65)+58
    ...
    f2_mod = 1.62
    W2_mod = 0.168
    beta_inst2 = betta_2e-16.6*(t2_-0.65)+54.3
    ...
    f2_mod = 1.22
    W2_mod = 0.112
    beta_inst2 = betta_2e-50.5*(t2_-0.6)+47.1
    ...
    f2_mod = 1.02
    W2_mod = 0.079
    beta_inst2 = betta_2e-20.8*(t2_-0.6)+43.7

print('Тип профиля:',  RotorBlade)    
print(f'Оптимальный относительный шаг t2_ = {t2_}')

z_2 = int((M.pi*d)/(b_2*t2_))
print(f'z_2 = {z_2}')
t2_ = (M.pi*d)/(b_2*z_2)

ksi_r_ = 4.364*b_2/l_2 + 4.22
k_1r = -13.79438991*M_2t**4 + 36.69102267*M_2t**3 - 32.78234341*M_2t**2 + 10.61998662*M_2t + 0.28528786
k_2r = 0.00331504*betta_1**2 - 0.21323910*betta_1 + 4.43127194
k_3r = 60.72813684*t2_**2 - 76.38053189*t2_ + 24.97876023
ksi_r = ksi_r_*k_1r*k_2r*k_3r

psi_r = (1-ksi_r/100)**0.5
print(f'psi_r = {psi_r:.4f}')
psi_r_ = 0.96 - 0.014*(b_2/l_2)
delta_psi = (psi_r_ - psi_r)/psi_r_*100
print(f'delta_psi = {delta_psi:.2f} %')
print(beta_inst2)
print(ksi_r_)
w_2 = w_2t * psi_r
print(f'w_2 = {w_2}')
c_2 = (w_2**2 + u**2 - 2*w_2*u*M.cos(M.radians(betta_2e)))**0.5
alpha_2 = M.degrees(M.atan(M.sin(M.radians(betta_2e))/(M.cos(M.radians(betta_2e))-u/w_2)))
delta_H_r = w_2t**2/2*(1-psi_r**2)
delta_H_vs = c_2**2/2
E_0 = H_0 - kappa_vs*delta_H_vs #E_0 = H_0, так как kappa_vs = 0
kpd_ol_1 = (E_0*1e3 - delta_H_s - delta_H_r - (1-kappa_vs)*delta_H_vs)/(E_0*1e3)
print(f'1. kpd_ol_1 = {kpd_ol_1:.4f}')
kpd_ol_2 = (u*(c_1*M.cos(M.radians(alpha_1))+c_2*M.cos(M.radians(alpha_2))))/(E_0*1e3)
print(f'2. kpd_ol_2 = {kpd_ol_2:.4f}')
c_1u = c_1*M.cos(M.radians(alpha_1))
c_1a = c_1*M.sin(M.radians(alpha_1))
w_1u = c_1u - u
...
xi_u_b=M.pi*d_per*delta_ekv*kpd_ol_1/F_1*M.sqrt(ro+1.8*l_2/d)
...
xi_segm = 0.25*B_2*l_2/F_1*ucf*kpd_ol_1*i_p
